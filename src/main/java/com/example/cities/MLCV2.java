...
public class MLCV2 {
    public String getTanito() {
        return tanito;
    }

    public void setTanito(String tanito) {
        this.tanito = tanito;
    }

    public String getKiertekelo() {
        return kiertekelo;
    }

    public void setKiertekelo(String kiertekelo) {
        this.kiertekelo = kiertekelo;
    }
    ...
    public MLCV2(String fájlNév, int classIndex, Classifier classifier){	// Classifier classifier: interface
